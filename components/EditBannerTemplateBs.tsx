  ...
  return (
    <div className={styles.editBanner}>
      ...
      <div className={styles.previewArea}>
        <div className={styles.banner} style={{ backgroundImage: `url(${editedBanner.background})` }}>
          <div className={styles.imageOverlay}>
            <img src={newImage || editedBanner.image} alt="Banner Preview" className={styles.previewImage} />
          </div>
